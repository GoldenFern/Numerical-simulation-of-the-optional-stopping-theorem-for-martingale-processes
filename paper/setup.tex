...
\sjtusetup{
  info = {
    ...
    zh / keywords   = {可选停止定理, 鞅, Monte Carlo 模拟, 停时, 赌徒破产, 保险破产},
    en / keywords   = {optional stopping theorem, martingale, Monte Carlo simulation, stopping time, gambler's ruin, insurance ruin},
    zh / author     = {杨逸飞},
